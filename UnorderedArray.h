...
public:
	...
	void push(T val)
	{
		...
		if (m_numElements >= m_maxSize) // Check if the array has to expland to accomadate the new data.
		{
				Expand(); 
		}
	...
	void remove(int index)
	{
		assert(m_array != nullptr);
			...
			{
				// I am trying to remove something outside of the bound of the array
				return; // <-- Maybe could should do some form of exception handling
			}
